...
// -------------------------------------------------------------------------------------                 
// Para rodar: gcc -o superficies superficies.cpp -lm -lglut -lGLU -lGL 
...
void processMenuEvents(int option)
{
    ...
    if (option == PtsControle)
        CarregaPontos("pontosDeControle.txt");  // ptosControleArbitra4x4   ptosControleSuperficieTrab pontosDeControle
...
{
	int menu, submenu, 	SUBmenuCor, SUBmenuTransladar, SUBmenuGirar,SUBmenuSuperficie,SUBmenuPintar;
	...
	SUBmenuCor = glutCreateMenu(processMenuEvents);
	...
	glutAddSubMenu("Objet Color", SUBmenuCor);
